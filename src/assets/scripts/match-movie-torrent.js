...
function getLevenshteinDistance() {
    ...
    console.log(levenshtein.get(toCompare[0], 'Guardians of the Galaxy', { useCollator: true }));
    console.log(levenshtein.get('Leon the professional', 'Léon: The Professional', { useCollator: true }));
    console.log(levenshtein.get('Leon the professional', 'Léon The Professional', { useCollator: true }));
    console.log(levenshtein.get('RUN', '!RUN', { useCollator: true }));
}

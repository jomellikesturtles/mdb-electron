...
class ListsRepository2 {
  ...
  save(body) {
    ...
    return new Promise(function (resolve, reject) {
      root.#listDbLocal.insert(body, (err, doc) => {
        if (!err) resolve(doc);
      });
    });
  }
  findPlayed(tmdbId) {
    ...
    return new Promise(function (resolve, reject) {
      ...
      root.#listDbLocal.findOne({ tmdbId: parseInt(tmdbId, 10) }, function (err, doc) {
        if (!err) {
...
module.exports = { ListsRepository2 };

import { IMdbMovieDetails, IRating, ILibraryInfo } from './interfaces'
import { IGenre, ISpokenLanguage } from './subject'
...
export class MdbMovieDetails implements IMdbMovieDetails {
    ...
    set releaseDate(v: string) {
        ...
        if (regexResults != null) {
            ...
            // in Date function, month 10 returns november, so minus 1

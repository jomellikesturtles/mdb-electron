...
- Analyze the current file/folder structure and identify feature areas (e.g., Node.js/Electron feature modules or Spring Boot service packages).
...
1. **Findings Summary**
1. **Risks Identified**
1. **Refactoring Target: [Feature Name]**
1. **Before / After File & Folder Structure**
1. **Before / After Key Code Examples**
1. **Refactoring Rationale**
1. **Recommendations for Other Similar Modules
      - include a list, respect the hierarchy and make sure refactoring will be modular**
1. **Golden Path for Future Features**
   ...
   Use terminology aligned with Node.js and/or Electron if applicable. You have access to the repository and workspace context.
